...
- Áudio só é enviado ao AssemblyAI quando Groq falha; a chave fica exclusivamente nos secrets do Cloudflare. Gemini e OpenRouter permanecem desativados mesmo com chave presente, até que o consentimento explícito correspondente seja configurado como `accepted`. O nível gratuito do Gemini pode usar conteúdo para melhorar produtos; o OpenRouter pode encaminhar a operadores distintos.
